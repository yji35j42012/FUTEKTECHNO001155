        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="background:#222;color:#ffffff;padding:20px;">
              <h2 style="margin:0;font-size:20px;">【Get Free Consultation】</h2>
              <p style="margin:5px 0 0;font-size:13px;color:#cccccc;">
                futektechno001155.com
              </p>
            </td>
          </tr>
            ...
            <td style="padding:20px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;color:#333;">  
                ...
                <tr>
                  ...
                  <td style="padding:8px 0;">' . htmlspecialchars($service) . '</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#f0f0f0;padding:15px;font-size:12px;color:#777;text-align:center;">
              This email was sent from futektechno001155.com contact form.
            </td>
          </tr>
...
try {
    ...
    // 設定寄件者（網域的信箱）
    $mail->setFrom('service@futektechno001155.com', 'futektechno001155.com');
